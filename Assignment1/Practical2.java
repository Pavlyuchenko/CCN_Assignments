...
public class Practical2 {
	...
	public static void main(String[] args) {
		 ...
		 * method) before sorting. When is an individual fit? How do you encode that
		 ...
		 * - DON'T make everything private. This will only complicate things. Keep
		 * variables local if possible
		 * - A common error are mistakes against pass-by-reference (this means that you
		 * pass the address of an object, not a copy of the object to the method). There
		 * is a deepclone method included in the Individual class. Use it!
